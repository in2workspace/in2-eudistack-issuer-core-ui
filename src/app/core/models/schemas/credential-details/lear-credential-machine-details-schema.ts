...
export const LearCredentialMachineDetailsViewModelSchema: ViewModelSchema = {
  main: [
      ...
      value: [
        ...
        { key: 'organizationId', type: 'key-value', value: (c: LEARCredentialMachine) => c.credentialSubject.mandate.mandator.organizationIdentifier ?? c.credentialSubject.mandate.mandator.id.replace('did:elsi:', '') },
